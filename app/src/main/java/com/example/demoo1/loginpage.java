...
public class loginpage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuthStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (mFirebaseUser != null) {
                    ...
                    Intent i = new Intent(loginpage.this, navigation_home_page.class);
                    startActivity(i);

                } else {
                    Toast.makeText(loginpage.this, " Login Again", Toast.LENGTH_SHORT).show();
                }
            }
        };
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (email.isEmpty()) {
                    ...
                    mFirebaseAuth.signInWithEmailAndPassword(email,pwd).addOnCompleteListener(loginpage.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (!task.isSuccessful()){
                                ...
                                Intent inttohome= new Intent(loginpage.this,navigation_home_page.class);
                    ...
                    Toast.makeText(loginpage.this, "Error Ocurred", Toast.LENGTH_SHORT).show();
                }
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intsignup = new Intent(loginpage.this,signup_page.class);
